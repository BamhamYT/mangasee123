...
const SOURCE_DOMAIN = "https://mangasee123.com"

export class Mangasee123 extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'Mangasee123' }
    get description(): string { return 'English Translated Manga and Manhwa' }
    get author(): string { return 'anon' }
